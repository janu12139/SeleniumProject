...
public class PlaceOrderRBC extends BaseTest{
  @Test
  public void PORBC() throws InterruptedException, IOException {
      ...
      driver.findElement(By.xpath("//input[@name='name']")).sendKeys("Buddy");
      driver.findElement(By.xpath("(//input[@name='email'])[2]")).sendKeys("Buddy.B@gmail.com");
      driver.findElement(By.xpath("(//button[@class='btn btn-default'])[2]")).click();
       ...
       driver.findElement(By.xpath("//input[@id='password']")).sendKeys(PW);
        ...
        driver.findElement(By.xpath("//input[@id='first_name']")).sendKeys(FN);
			...
			driver.findElement(By.xpath("(//a[@class='btn btn-default add-to-cart'])[9]")).click();
